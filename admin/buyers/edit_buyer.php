<?php
    ...
    if(strlen($_SESSION['artid'])) {
        ...
        if(isset($_POST['submit'])) {
            ...
            $editB = mysqli_query($dbcon,"UPDATE buyers
                                            SET name='$fullname', phone ='$contactno', email='$email', award='$address' 
                                            WHERE ID = '$editID' " );
            if($editB) {
                "<script>alert('Buyers has been update.');</script>";
            } else {
                        ...
                        <section class="panal">
                            ...
                            <div class="panel-body">
                                <form class="form-horizontal" method="post" action="">
                                    ...
                                    <?php
                                        $editID = $_GET['editid'];
                                        $qAts = mysqli_query($dbcon,"SELECT * buyers WHERE id='$editID' ");
                                        $count = 1;
                                    ...
                                    <div class="form-group">
                                        <label class="col-sm-2" for="Contactno">Phone Number</label>
                                        <div class="col-sm-10">
                                            <input type="text" class="form-control" id="contactno" name="contactno" maxlength="10" required="true"
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-10">
                                            <textarea class="form-control" name="address" id="address" required="true">
                                                <?php $result['award'];?>
                                            </textarea>
                                        </div>
                                    </div>
